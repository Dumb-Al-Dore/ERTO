...
public class AdminController {
	...
	@GetMapping("/ladmin")               //handler method
	...
	// Get method for showing LL status edit page and fetch the filled up data using @requestparam
	@GetMapping("/ledit")
	public ModelAndView showEditLearningTable(@RequestParam int vid, Model map, HttpServletRequest request) {
		...
		return new ModelAndView("/admin/ledit"); // viewname resolve by viewresolver and redirect controll to admin/ledit.jsp
	}
